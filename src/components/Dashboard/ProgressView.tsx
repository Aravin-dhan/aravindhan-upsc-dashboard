...
export default function ProgressView() {
    ...
    return (
        ...
        >
            <div className="shrink-0 p-4 border-b border-stone-200 dark:border-slate-800 flex items-center justify-between bg-stone-50/50 dark:bg-slate-800/50">
                <div className="flex items-center gap-2">
                    <PieChartIcon className="w-5 h-5 text-primary dark:text-amber-500" />
                    <h2 className="font-bold text-stone-800 dark:text-slate-200">Progress Analytics</h2>
                </div>
            </div>
            ...
            <div className="flex-1 p-4 min-h-0 flex flex-col">
                ...
                {/* Summary Stats */}
                <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-stone-200 dark:border-slate-800">
                    <div className="text-center">
                        <div className="text-2xl font-bold text-slate-800 dark:text-slate-200 font-serif">{syllabus.length}</div>
                        <div className="text-xs text-slate-500 uppercase tracking-wider">Papers</div>
                    </div>
                    <div className="text-center">
                        <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-500 font-serif">
